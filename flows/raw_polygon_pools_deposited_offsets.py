...
@flow()
def raw_polygon_pools_deposited_offsets():
...
def raw_polygon_pools_deposited_offsets_flow(result_storage):
    """Fetches Polygon pools deposited offsets and stores it"""
    raw_polygon_pools_deposited_offsets.with_options(result_storage=result_storage)()


if __name__ == "__main__":
    from dotenv import load_dotenv
    load_dotenv()
    raw_polygon_pools_deposited_offsets()
