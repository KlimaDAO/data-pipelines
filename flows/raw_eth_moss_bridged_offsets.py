...
@flow()
def raw_eth_moss_bridged_offsets():
...
@flow()
def raw_eth_moss_bridged_offsets_flow(result_storage):
    """Fetches Ethereum Moss bridged offsets and stores it"""
    raw_eth_moss_bridged_offsets.with_options(result_storage=result_storage)()
